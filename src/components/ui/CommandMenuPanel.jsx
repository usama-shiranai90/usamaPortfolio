...
// The palette body. Split out of CommandMenu so cmdk and its icon set are
// fetched on first open rather than on every page load. Open/close state lives
// in the parent shell, which is what stays mounted.
export function CommandMenuPanel({ open, setOpen }) {
